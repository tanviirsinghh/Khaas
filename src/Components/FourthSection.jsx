      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-sm mx-26 grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
            ...
            <div className="flex flex-col h-full  p-3 mx-3 bg-green-950" data-aos="fade-up">
              {/* <div>
                <div className="relative inline-flex flex-col mb-4"> */}
                  <img className="h-full w-full" src="/src/Components/Khass/brown fabric.jpg" width={48} height={48} alt="Testimonial 01" />
            ...
            <img className="h-full w-full" src="/src/Components/Khass/wall and hanger.jpg" width={48} height={48} alt="Testimonial 01" />
            ...
            <img className="h-full w-full" src="/src/Components/Khass/white fabric.jpg" width={48} height={48} alt="Testimonial 01" />
