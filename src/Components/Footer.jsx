...
export default function Footer() {
  return (
    ...
    <aside>
        <img className="h-14" src="../Khass/fl.svg" alt="" />
    ...
    <nav>
      <div className="grid grid-flow-col gap-4 ">
        <a href="https://www.instagram.com/khaasbypunjabfabrics/profilecard/?igsh=MWw1OGI4Znp0Mnlzbw==">
          ...
          <img className="h-8" src="../Khass/insta.svg" alt="" />
        

        </a>
        <a href="">
          
                    <img className="h-8" src="../Khass/fb.svg" alt="" />

        </a>
        <a href="" target="_blank" className="hover:cursor-auto">
         
     <img className="h-8" src="../Khass/youtube.svg" alt="" />
